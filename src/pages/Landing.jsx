...
import Activity from '../IMAGES/Activity_Timeline.png';
import RealTime from '../IMAGES/RealTime_Alert.png';
import SmartPlayback from '../IMAGES/Smart_Video_Playback.png';
import Predictive from '../IMAGES/Predictive_intelligence.png';
import { useNavigate } from 'react-router-dom';
import { Shield, Camera, Bell, ArrowRight, Play, Star, Users, MapPin, Zap } from 'lucide-react';
import obexLogo from '../obex-logo-noText.png';
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10 mb-20 lg:mb-32">
              <div className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 lg:p-10 rounded-3xl border border-white/20 shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 transform hover:scale-105 hover:border-cyan-400/30">
                <div className="w-20 h-20 bg-gradient-to-r from-cyan-400 to-cyan-600 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="space-y-24 mb-32">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-12 bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80 backdrop-blur-xl p-8 lg:p-12 rounded-3xl border border-white/10 shadow-2xl">
                <div className="flex-1 text-left space-y-6">
                  <div className="inline-block px-6 py-2 bg-gradient-to-r from-cyan-500/30 to-blue-500/30 border border-cyan-400/50 rounded-full">
                    <span className="text-cyan-200 font-bold text-sm tracking-wider">01 — INSTANT AWARENESS</span>
                  </div>
                  ...
                  <p className="text-lg lg:text-xl text-slate-200 leading-relaxed">
                    OBEX ensures you don't just watch events unfold, you act on them the moment they happen.
                  </p>
                </div>
                <div className="flex-1">
                  <div className="relative group">
                    <div className="absolute -inset-2 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-3xl blur-2xl opacity-40 group-hover:opacity-60 transition-opacity duration-500"></div>
                    <div className="relative bg-slate-950/50 p-3 rounded-3xl border-2 border-cyan-400/30">
                      <img 
                        src={RealTime} 
                        alt="Real-Time Alerts Dashboard" 
              ...
              <div className="flex flex-col md:flex-row-reverse items-center gap-8 lg:gap-12 bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80 backdrop-blur-xl p-8 lg:p-12 rounded-3xl border border-white/10 shadow-2xl">
                <div className="flex-1 text-left md:text-right space-y-6">
                  <div className="inline-block px-6 py-2 bg-gradient-to-r from-cyan-500/30 to-blue-500/30 border border-cyan-400/50 rounded-full">
                    <span className="text-cyan-200 font-bold text-sm tracking-wider">02 — VISUAL CLARITY</span>
                  </div>
                  <h2 className="text-3xl lg:text-5xl font-extrabold text-white leading-tight">
                    Activity Timeline
                  </h2>
                  <p className="text-lg lg:text-xl text-slate-200 leading-relaxed">
                    See what happened, when it happened, and how OBEX responded all in a clean, visual interface.
                  </p>
                </div>
                <div className="flex-1">
                  <div className="relative group">
                    ...
                    <div className="relative bg-slate-950/50 p-3 rounded-3xl border-2 border-cyan-400/30">
                      <img 
                        src={Activity}
                        alt="Activity Timeline Interface" 
                        className="relative rounded-2xl w-full shadow-2xl"
                      />
                    </div>
                  </div>
              ...
              {/* Feature 3: Smart Video Playback */}
              <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-12 bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80 backdrop-blur-xl p-8 lg:p-12 rounded-3xl border border-white/10 shadow-2xl">
                <div className="flex-1 text-left space-y-6">
                  <div className="inline-block px-6 py-2 bg-gradient-to-r from-cyan-500/30 to-blue-500/30 border border-cyan-400/50 rounded-full">
                    <span className="text-cyan-200 font-bold text-sm tracking-wider">03 — INTELLIGENT REVIEW</span>
                  </div>
                  <h2 className="text-3xl lg:text-5xl font-extrabold text-white leading-tight">
                    Smart Video Playback
                  </h2>
                  <p className="text-lg lg:text-xl text-slate-200 leading-relaxed">
                    OBEX highlights key events and activities so you can quickly review what matters most.
                  </p>
                </div>
                <div className="flex-1">
                  <div className="relative group">
              ...
              {/* Feature 4: Predictive Intelligence */}
              <div className="flex flex-col md:flex-row-reverse items-center gap-8 lg:gap-12 bg-gradient-to-br from-slate-900/80 via-slate-800/80 to-slate-900/80 backdrop-blur-xl p-8 lg:p-12 rounded-3xl border border-white/10 shadow-2xl">
                <div className="flex-1 text-left md:text-right space-y-6">
                  <div className="inline-block px-6 py-2 bg-gradient-to-r from-cyan-500/30 to-blue-500/30 border border-cyan-400/50 rounded-full">
                    <span className="text-cyan-200 font-bold text-sm tracking-wider">04 — PREDICTIVE AI</span>
                  </div>
                  <h2 className="text-3xl lg:text-5xl font-extrabold text-white leading-tight">
                    Predictive Intelligence
                  </h2>
                  <p className="text-lg lg:text-xl text-slate-200 leading-relaxed">
                    OBEX's AI learns patterns in your space, predicts potential risks, and warns you before incidents escalate.
                  </p>
                </div>
                <div className="flex-1">
                  <div className="relative group">
